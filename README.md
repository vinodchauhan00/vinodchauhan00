...
### 🚀 About Me
I'm a **Software Engineer** from 🇮🇳 India, working across **MERN Stack development** and exploring **DevOps & Cloud infrastructure** — Linux, AWS, GitHub, and server monitoring. I have 1+ year of professional experience and enjoy building real-world, production-ready applications.
...
A real-time fleet monitoring platform built on **Stremex (JT808 protocol)**, live-tracking **10,000+ buses** across Delhi NCR and other major cities.

- 📍 **Live Tracking:** real-time location updates for every bus, city-wide
- 🎥 **Live Recording:** trip history & route playback
